...
public class HashDoubleHashingTest {
    ...
    public void should_throwException_WhenSizeIsThree() {
        //given
        int size = 3;

        //when
        HashTable<Double> hash = new HashDoubleHashing<>(size);
    ...
    @Test
    public void should_CorrectlyIncreaseSize() {
        //given
        int size = 1;
    ...
    public void should_CorrectlyAddAndDeleteElems_WhenElemsHaveSameHashCode() {
        ...
        HashTable<TestObject> hash = new HashDoubleHashing<>();
    ...
    public void should_CorrectlyPutGetAndDeleteElems_WhenOperateOnManyElemsWithSameHashCode() {
        ...
        HashTable<TestObject> hash = new HashDoubleHashing<>(size);
        boolean state = true;
